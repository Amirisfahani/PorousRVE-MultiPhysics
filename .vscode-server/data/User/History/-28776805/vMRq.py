...
if MPI.COMM_WORLD.rank == 0:
    ...
    # ct.array contains all connectivity data in flat form
    num_cells = msh.topology.index_map(tdim).size_local
    num_nodes_per_cell = ct.num_nodes
    # Reshape flat array to (num_cells, num_nodes_per_cell)
    cells_dolfinx = ct.array.reshape(-1, num_nodes_per_cell)
