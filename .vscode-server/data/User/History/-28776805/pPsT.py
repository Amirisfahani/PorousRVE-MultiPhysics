...
if MPI.COMM_WORLD.rank == 0:
    ...
    # Get cells from mesh topology - use dolfin's native connectivity
    msh.topology.create_connectivity(tdim, 0)
    ...
    num_nodes_per_cell = msh.topology.connectivity(tdim, 0).num_nodes
    
    # Extract cell data from connectivity - it's stored differently
